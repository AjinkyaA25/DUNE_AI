...
def create_imperium_cards() -> List[Card]:
    ...
    return [
        ...
        m("Smuggler's Haven", 4, I, access=["spacing_guild", "desert"], tags=["spacing_guild"],
          agent={"may_convert": {"cost": {"persuasion": 4}, "gain": {"solari": 1}}},
          persuasion=1, notes="'+2 persuasion if spying on a Maker space' not modelled."),
        ...
        m("Spacing Guild's Favor", 5, I, access=["spacing_guild", "desert"],
          tags=["spacing_guild"], agent={"solari": 1}, persuasion=2,
          notes="'Spend 3 persuasion for a reward' and discard bonus not modelled."),
        m("Spy Network", 2, I, access=["spy"], tags=["emperor", "spacing_guild"],
          agent={"persuasion": 2, "swords": 1, "if_spies_2": {"spy_special": 1}},
          persuasion=1, reveal={"troops": 1}),
        m("Steersman", 8, I, access=["spacing_guild", "landsraad", "city", "desert"],
          tags=["spacing_guild"], acquire={"spice": 1},
          agent={"troops": 1, "deploy": 1}, persuasion=2, reveal={"spice": 2}),
        m("Stilgar, the Devoted", 6, I, access=["city", "desert"], tags=["fremen"],
          agent={"troops": 2},
